...
version = sfrmaker.__version__
# The full version, including alpha/beta/rc tags.
release = sfrmaker.__version__
...
man_pages = [
    (master_doc, 'sfrmaker', 'SFRmaker Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sfrmaker', 'SFRmaker Documentation',
     author, 'sfrmaker', 'Rapid construction of streamflow-routing networks from source hydrography data.',
     'Miscellaneous'),
]
